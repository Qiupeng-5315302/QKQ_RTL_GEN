...
`define __GUARD__DWC_MIPICSI2_DEVICE_CC_CONSTANTS__VH__
...
// Default:      1 ((CSI2_DEVICE_DATAINTERFACE == 2)||(CSI2_DEVICE_DATAINTERFACE == 
//               3))
// Values:       0, 1
// 
...
// Default:      1 (CSI2_DEVICE_DATAINTERFACE == 3)
// Values:       0, 1
// 
...
// Default:      1 ((CSI2_DEVICE_IDI_IPI_IF == 1)||(CSI2_DEVICE_NR_IPI >= 2))
// Values:       0, 1
// 
...
`define CSI2_DEVICE_IPI_LANE_NUM 4
...
// Default:      1 (CSI2_DEVICE_IPI_LANE_NUM > 1)
// Values:       0, 1
// 
...
// Default:      1 ((CSI2_DEVICE_IDI_IPI_IF == 1)||(CSI2_DEVICE_IPI2_IF == 1))
// Values:       0, 1
// 
...
// Default:      4096 ([<functionof> CSI2_DEVICE_IDI_PLD_FIFO_DEPTH ])
...
`define CSI2_DEVICE_IPI_PLD_FIFO_DEPTH 4096


// Name:         CSI2_DEVICE_IPI_PLD_RAM_DEPTH
// Default:      4096 ([<functionof> CSI2_DEVICE_IPI_PLD_FIFO_DEPTH ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
...
`define CSI2_DEVICE_IPI_PLD_RAM_DEPTH 4096
...
// Default:      27 (CSI2_DEVICE_IPI_LANE_NUM > 1 ? 27 : 9)
// Values:       -2147483648, ..., 2147483647
// 
// IPI input parity width
`define CSI2_DEVICE_IPI_DATA_PARITY_WIDTH 27
...
// Default:      256 (CSI2_DEVICE_IPI_LANE_NUM > 1 ? 256 : 64)
// Values:       -2147483648, ..., 2147483647
// 
// Select the IPI output payload width
`define CSI2_DEVICE_IPI_PL_O_WIDTH 256


// Name:         CSI2_DEVICE_NAP_IPI_PL_FIFO_WIDTH
// Default:      256 (CSI2_DEVICE_IPI_LANE_NUM > 1 ? 256 : CSI2_DEVICE_MAX_PPI_WIDTH 
//               > 64 ? 128 : 64)
// Values:       -2147483648, ..., 2147483647
// 
// Selects the width when push IPI payload into FIFO without Automotive Package function
`define CSI2_DEVICE_NAP_IPI_PL_FIFO_WIDTH 256
...
// Default:      10 (((CSI2_DEVICE_IPI_LANE_NUM > 1) || (CSI2_DEVICE_MAX_PPI_WIDTH > 
//               128)) ? 10 : CSI2_DEVICE_MAX_PPI_WIDTH > 64 ? 9 : 8)
// Values:       -2147483648, ..., 2147483647
// 
// Select the IPI output payload ecc width
`define CSI2_DEVICE_IPI_PL_ECC_WIDTH 10


// Name:         CSI2_DEVICE_IPI_PLD_WIDTH
// Default:      266 ([<functionof> CSI2_DEVICE_AP CSI2_DEVICE_NAP_IPI_PL_FIFO_WIDTH 
//               CSI2_DEVICE_IPI_PL_ECC_WIDTH])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// The width of the external payload RAM for IPI
`define CSI2_DEVICE_IPI_PLD_WIDTH 266
...
// Default:      3 (CSI2_DEVICE_IDI_IF + CSI2_DEVICE_IPI_IF + CSI2_DEVICE_VPG + 
//               CSI2_DEVICE_SDI_IF)
// Values:       1 2 3 4
// 
// CSI2_DEVICE_INTERFACE_NUM: 
// Select the number of system data interface
`define CSI2_DEVICE_CHANNEL_NUM 3
...
`define CSI2_DEVICE_IDI_PLD_FIFO_AWIDTH 12


// Name:         CSI2_DEVICE_IDI_PLD_FIFO_CWIDTH
// Default:      13 ([<functionof> CSI2_DEVICE_IDI_PLD_RAM_DEPTH])
// Values:       -2147483648, ..., 2147483647
// 
// Bus width to report the number of words in the IDI payload fifo.
`define CSI2_DEVICE_IDI_PLD_FIFO_CWIDTH 13
...
// Default:      12 ([<functionof> CSI2_DEVICE_IPI_PLD_RAM_DEPTH])
// Values:       -2147483648, ..., 2147483647
// 
// Address bus width in the IPI payload FIFO
`define CSI2_DEVICE_IPI_PLD_FIFO_AWIDTH 12


// Name:         CSI2_DEVICE_IPI_PLD_FIFO_CWIDTH
// Default:      13 ([<functionof> CSI2_DEVICE_IPI_PLD_RAM_DEPTH])
// Values:       -2147483648, ..., 2147483647
// 
// Bus width to report the number of words in the IPI payload fifo.
`define CSI2_DEVICE_IPI_PLD_FIFO_CWIDTH 13
...
//Revision: $Id: DWC_mipicsi2_device_cc_constants.vh 1 2023/12/24 06:48:27 GMT qiupeng Exp $
