...
`define __GUARD__DWC_MIPICSI2_DEVICE_CONSTANTS__VH__
...
// ------------------------------------------------------------
  ...
  `define  CSI2_DEVICE_INT_ST_IPI_OS              12'h10c
  ...
  `define  CSI2_DEVICE_INT_MASK_N_IPI_OS          12'h170
  `define  CSI2_DEVICE_INT_FORCE_IPI_OS           12'h174
  ...
  `define  CSI2_DEVICE_PHY_SWITCH_TIME_OS         12'h324
  ...
  `define  CSI2_DEVICE_TX_HS_IDLE_TIME_OS             12'h358
  ...
  // IPI Related Register Address
  `define  CSI2_DEVICE_IPI_PKT_CFG_OS             12'h600
  `define  CSI2_DEVICE_IPI_PIXELS_OS              12'h604
  `define  CSI2_DEVICE_IPI_MAX_FRAME_NUM_OS       12'h608
  `define  CSI2_DEVICE_IPI_START_LINE_NUM_OS      12'h60c
  `define  CSI2_DEVICE_IPI_STEP_LINE_NUM_OS       12'h610
  `define  CSI2_DEVICE_IPI_LINES_OS               12'h614
  `define  CSI2_DEVICE_IPI_DATA_SEND_START_OS     12'h618
  `define  CSI2_DEVICE_IPI_FIFO_STATUS_OS         12'h61c

  // Simultaneous IDI & IPI Related Register Address
  `define  CSI2_DEVICE_IPI_TRANS_STATUS_OS        12'h640
  `define  CSI2_DEVICE_IPI_HSA_HBP_PPI_TIME_OS    12'h644
  `define  CSI2_DEVICE_IPI_HLINE_PPI_TIME_OS      12'h648
  `define  CSI2_DEVICE_IPI_VSA_LINES_OS           12'h64c
  `define  CSI2_DEVICE_IPI_VBP_LINES_OS           12'h650
  `define  CSI2_DEVICE_IPI_VFP_LINES_OS           12'h654
  `define  CSI2_DEVICE_IPI_ACT_LINES_OS           12'h658
  `define  CSI2_DEVICE_IPI_FB_LINES_OS            12'h65c
  `define  CSI2_DEVICE_IPI_INSERT_CTRL_OS         12'h660
  ...
  `define  CSI2_DEVICE_INT_ST_FAP_IPI_OS                 12'h810
  ...
  `define  CSI2_DEVICE_INT_MASK_N_FAP_IPI_OS             12'h878
  `define  CSI2_DEVICE_INT_FORCE_FAP_IPI_OS              12'h87c
  ...
  `define  CSI2_DEVICE_IPI_AP_STATUS_OS                  12'h900
  ...
  `define  CSI2_DEVICE_IPI_FIFOCTRL_AP_STATUS_OS         12'h914
  ...
  `define  CSI2_DEVICE_MASK_N_IPI_AP_STATUS_OS           12'h9c0
  `define  CSI2_DEVICE_FORCE_IPI_AP_STATUS_OS            12'h9c4
  ...
  `define  CSI2_DEVICE_MASK_N_IPI_FIFOCTRL_AP_STATUS_OS  12'h9e8
  `define  CSI2_DEVICE_FORCE_IPI_FIFOCTRL_AP_STATUS_OS   12'h9ec
  ...
  `define  CSI2_DEVICE_ERR_INJ_D159_128_MASK_OS          12'hb1c
  `define  CSI2_DEVICE_ERR_INJ_D191_160_MASK_OS          12'hb20
  `define  CSI2_DEVICE_ERR_INJ_D223_192_MASK_OS          12'hb24
  `define  CSI2_DEVICE_ERR_INJ_D255_224_MASK_OS          12'hb28

  // Faulty Address Logger
  `define CSI2_DEVICE_IDI_RAM_ERR_LOG_AP_OS              12'hb2c
  `define CSI2_DEVICE_IDI_RAM_ADDR_LOG_AP_OS             12'hb30
  `define CSI2_DEVICE_IPI_RAM_ERR_LOG_AP_OS              12'hb34
  `define CSI2_DEVICE_IPI_RAM_ADDR_LOG_AP_OS             12'hb38
...
// -----------------------------------------------------------
  ...
  `define  CSI2_DEVICE_INT_IPI_RS                       5
  ...
  `define  CSI2_DEVICE_PHY_HS_IDLE_TIME_AUTO_RS        16
   ...
   //IPI related registers
  `define  CSI2_DEVICE_IPI_PKT_CFG_RS                  18
  `define  CSI2_DEVICE_IPI_DT_RS                        6
  `define  CSI2_DEVICE_IPI_VC_RS                        2
  `define  CSI2_DEVICE_IPI_HSYNC_EN_RS                  1
  `define  CSI2_DEVICE_IPI_LINE_NUM_MODE_RS             2
  `define  CSI2_DEVICE_IPI_FRAME_NUM_MODE_RS            1
  `define  CSI2_DEVICE_IPI_MODE_RS                      2

  `define  CSI2_DEVICE_IPI_PIXELS_RS                   17
  `define  CSI2_DEVICE_IPI_MAX_FRAME_NUM_RS            16
  `define  CSI2_DEVICE_IPI_START_LINE_NUM_RS           16
  `define  CSI2_DEVICE_IPI_STEP_LINE_NUM_RS            16
  `define  CSI2_DEVICE_IPI_LINES_RS                    17
  `define  CSI2_DEVICE_IPI_DATA_SEND_START_RS          17
  `define  CSI2_DEVICE_IPI_FIFO_STATUS_RS               4



  // Simultaneous IDI & IPI Related Register Width
  `define  CSI2_DEVICE_IPI_TRANS_STATUS_RS              1
  `define  CSI2_DEVICE_IPI_HSA_HBP_PPI_TIME_RS         13
  `define  CSI2_DEVICE_IPI_HLINE_PPI_TIME_RS           19
  `define  CSI2_DEVICE_PHY_SWITCH_TIME_RS              32
  `define  CSI2_DEVICE_PHY_HS2LP_TIME_RS               16
  `define  CSI2_DEVICE_PHY_LP2HS_TIME_RS               16
  `define  CSI2_DEVICE_IPI_VSA_LINES_RS                10
  `define  CSI2_DEVICE_IPI_VBP_LINES_RS                10
  `define  CSI2_DEVICE_IPI_VFP_LINES_RS                10
  `define  CSI2_DEVICE_IPI_ACT_LINES_RS                14
  `define  CSI2_DEVICE_IPI_FB_LINES_RS                  8
  `define  CSI2_DEVICE_IPI_INSERT_CTRL_RS               2
  `define  CSI2_DEVICE_IPI_VACT_INSERT_EN_RS            1
  `define  CSI2_DEVICE_IPI_FB_INSERT_EN_RS              1
  `define  CSI2_DEVICE_IPI_1ST_LINE_PPI_TIME_RS        (`CSI2_DEVICE_IPI_HLINE_PPI_TIME_RS+`CSI2_DEVICE_IPI_VSA_LINES_RS+1)
  `define  CSI2_DEVICE_IPI_VFP_PPI_TIME_RS             (`CSI2_DEVICE_IPI_HLINE_PPI_TIME_RS+`CSI2_DEVICE_IPI_VFP_LINES_RS)
  `define  CSI2_DEVICE_IPI_VBLANK_PPI_TIME_RS          (`CSI2_DEVICE_IPI_HLINE_PPI_TIME_RS+`CSI2_DEVICE_IPI_FB_LINES_RS+1)
  `define  CSI2_DEVICE_IPI_1ST_LINE_BYTES_RS           (`CSI2_DEVICE_IPI_1ST_LINE_PPI_TIME_RS+`CSI2_DEVICE_PLD_BYTEEN_WIDTH)
  `define  CSI2_DEVICE_IPI_VFP_BYTES_RS                (`CSI2_DEVICE_IPI_VFP_PPI_TIME_RS+`CSI2_DEVICE_PLD_BYTEEN_WIDTH)
  `define  CSI2_DEVICE_IPI_VBLANK_BYTES_RS             (`CSI2_DEVICE_IPI_VBLANK_PPI_TIME_RS+`CSI2_DEVICE_PLD_BYTEEN_WIDTH)
  `define  CSI2_DEVICE_IPI_HLINE_BYTES_RS              (`CSI2_DEVICE_IPI_HLINE_PPI_TIME_RS+`CSI2_DEVICE_PLD_BYTEEN_WIDTH)
  `define  CSI2_DEVICE_IPI_HSA_HBP_BYTES_RS            (`CSI2_DEVICE_IPI_HSA_HBP_PPI_TIME_RS+`CSI2_DEVICE_PLD_BYTEEN_WIDTH)
  `define  CSI2_DEVICE_PHY_LP2HS_BYTES_RS              (`CSI2_DEVICE_PHY_LP2HS_TIME_RS+`CSI2_DEVICE_PLD_BYTEEN_WIDTH)
  `define  CSI2_DEVICE_PHY_HS2LP_BYTES_RS              (`CSI2_DEVICE_PHY_HS2LP_TIME_RS+`CSI2_DEVICE_PLD_BYTEEN_WIDTH+1)
  `define  CSI2_DEVICE_PHY_SWITCH_BYTES_RS             (`CSI2_DEVICE_PHY_HS2LP_TIME_RS+`CSI2_DEVICE_PLD_BYTEEN_WIDTH+1)
  `define  CSI2_DEVICE_IPI_SPARE_BYTES_CNT_RS          `CSI2_DEVICE_IPI_1ST_LINE_BYTES_RS
  ...
  `define  CSI2_DEVICE_IPI_AP_STATUS_RS                2
  `define  CSI2_DEVICE_IPI_FIFOCTRL_AP_STATUS_RS       6
...
`define  CSI2_DEVICE_PKT_IF_AP_STATUS_RS             (2 +1)
...
\
    ...
    `define  CSI2_DEVICE_IPI_EMBEDDED_LENGTH_WIDTH       12
    `define  CSI2_DEVICE_IPI_CHK_DATA_WIDTH              216
...
//Revision: $Id: DWC_mipicsi2_device_constants.vh 1 2023/12/24 06:48:27 GMT qiupeng Exp $
