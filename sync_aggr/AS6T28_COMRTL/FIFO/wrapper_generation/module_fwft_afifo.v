...
module {module_name}_1r1w_{ram_depth}x{data_width}_fwft_afifo_wrapper(/*AUTOARG*/
   // Outputs
   ...
   ecc_fault_detc_en, wr_data, wr_en, rd_en, wr_domain_clear, rd_domain_clear
    ...
    {module_name}_1r1w_{ram_depth}x{data_width}_afifo_wrapper #(
        .FLIPFLOP                  ( FLIPFLOP                  ),
    ...
    ) u0_{module_name}_1r1w_{ram_depth}x{data_width}_afifo_wrapper (
